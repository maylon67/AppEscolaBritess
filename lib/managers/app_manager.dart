...
/*
  ...
  Future<List<ItensCompra>> carregaItensDaOrdemDeCompra(int idDoItem) async{
    Future<List<ItensCompra>> itens = WsController().getAllItensFromWs(idDoItem);
    return itens;
  }

  Future<List<Funcionario>> carregaAllUsuario() async{
    Future<List<Funcionario>> funcioanarios = WsController().getAllFuncionariosFromWs();
    return funcioanarios;
  }

  Future<List<ItensVenda>> carregaItensDaVenda(int idDoItem) async{
    Future<List<ItensVenda>> itens = WsController().getAllItensDaVendasFromWs(idDoItem);
    return itens;
  }

  Future<List<ContasPagar>> carregaContasPagar() async{
    Future<List<ContasPagar>> listContas = WsController().getAllContasPagarFromWs();
    return listContas;
  }

  Future<List<Venda>> carregaVendas() async{
    Future<List<Venda>> vendas = WsController().getAllVendasFromWs();
    return vendas;
  }
*/
